...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        const response = await fetch(`/api/products/${productId}?organization_id=bd69447b6c844e51898b7defad628fd1&Appid=J5W67RSC78B84Y2&Apikey=2517b21ed8b3426b98f5e10ceee4d83920240712125230361802`);
        if (!response.ok) {
